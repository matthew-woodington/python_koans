...
class AboutStrings(Koan):
    ...
    def test_triple_quote_strings_are_also_strings(self):
        string = """Howdy, world!"""
        # tripple quotes are also strings and can span multiple lines
        # self.assertEqual(__, isinstance(string, str))
        self.assertEqual(True, isinstance(string, str))
    ...
    def test_raw_strings_are_also_strings(self):
        ...
        # raw strings are created with r"__" or R'__'
        # the raw strings treat backslashes as actual characters
        # used to handle things like file paths
    ...
    def test_use_backslash_at_the_end_of_a_line_to_continue_onto_the_next_line(self):
        # this will display on seperate lines when print() is used
...
"""
    ...
    def test_triple_quoted_strings_need_less_escaping(self):
        # tripple quotes will result in the same string being printed
        a = "Hello \"world\"."
        b = """Hello "world"."""
        # self.assertEqual(__, (a == b))
        self.assertEqual(True, (a == b))
